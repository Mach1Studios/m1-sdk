...
float ACubeSound::ClosestPointOnBox(FVector point, FVector center, FVector axis0, FVector axis1, FVector axis2, FVector extents, FVector & closestPoint)
{
...
// Called every frame
void ACubeSound::Tick(float DeltaTime)
{
...
void ACubeSound::PostEditChangeProperty(FPropertyChangedEvent & PropertyChangedEvent)
{
