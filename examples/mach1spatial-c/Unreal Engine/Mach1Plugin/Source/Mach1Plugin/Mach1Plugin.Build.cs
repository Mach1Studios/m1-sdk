...
{
    public class Mach1Plugin : ModuleRules
    {
        ...
        {
            Log.TraceInformation("start building Mach1Plugin...");
            ...
            else if (Target.Platform == UnrealTargetPlatform.Mac)
            {
                ...
                RuntimeDependencies.Add(new RuntimeDependency(Path.Combine(Mach1BinDirectory, "libMach1DecodePositionalCAPI.dylib")));
            ...
            else if (Target.Platform == UnrealTargetPlatform.Win32 || Target.Platform == UnrealTargetPlatform.Win64)
            {
                ...
                RuntimeDependencies.Add(new RuntimeDependency(Path.Combine(Mach1BinDirectory, "Mach1DecodePositionalCAPI.dll")));
