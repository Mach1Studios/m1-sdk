...
class HorizonPairsTwo: public BaseAudioTest {
public:
    HorizonPairsTwo() {
        ...
        for (int i = 0; i < 4; i++){
            ...
            playersLeft[1].load("2/3.wav"); playersLeft[1].setLoop(true);
            playersLeft[2].load("2/5.wav"); playersLeft[2].setLoop(true);
            playersLeft[3].load("2/7.wav"); playersLeft[3].setLoop(true);
            playersLeft[i].setPan(-1);
            playersRight[0].load("2/2.wav"); playersRight[0].setLoop(true);
            playersRight[1].load("2/4.wav"); playersRight[1].setLoop(true);
            playersRight[2].load("2/6.wav"); playersRight[2].setLoop(true);
            playersRight[3].load("2/8.wav"); playersRight[3].setLoop(true);
        ...
        mach1Decode.setAlgorithmType(m1HorizonPairs);
