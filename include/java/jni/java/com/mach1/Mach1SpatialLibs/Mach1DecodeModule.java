...
public class Mach1DecodeModule {
  ...
  public static void Mach1DecodeCAPI_decode(SWIGTYPE_p_void M1obj, SWIGTYPE_p_float result, int bufferSize, int sampleIndex) {
    Mach1DecodeModuleJNI.Mach1DecodeCAPI_decode(SWIGTYPE_p_void.getCPtr(M1obj), SWIGTYPE_p_float.getCPtr(result), bufferSize, sampleIndex);
  }
