...
#include "external/cpp/Mach1DecodePositional.cpp"
...
EMSCRIPTEN_BINDINGS(Mach1DecodePositional) {
    ...
    class_<Mach1DecodePositional>("Mach1DecodePositionalInternal")
        ...
        .function("getCoefficients", &Mach1DecodePositional::getCoefficients, allow_raw_pointers())
        ...
        .function("getVolumesWalls", &Mach1DecodePositional::getVolumesWalls, allow_raw_pointers())
        ...
        .function("getVolumesRoom", &Mach1DecodePositional::getVolumesRoom, allow_raw_pointers())
        .function("getCoefficientsInterior", &Mach1DecodePositional::getCoefficientsInterior, allow_raw_pointers())
        ;
}
