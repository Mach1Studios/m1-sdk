...
/* DEPRECATED START*/
        ...
        this.setCameraPosition = function(pos) {
            if (this._m1obj) {
                this._m1obj.setCameraPosition(pos);
            }
        };

        this.setCameraRotation = function(rot) {
            if (this._m1obj) {
                this._m1obj.setCameraRotation(rot);
            }
        };

        this.setCameraRotationQuat = function(quat) {
            if (this._m1obj) {
                this._m1obj.setCameraRotationQuat(quat);
            }
        };
