...
Module['onRuntimeInitialized'] = function() {
    ...
    this.setAzimuth0to1 = function(azimuth) {
      if (this._m1obj) {
        this._m1obj.setAzimuth0to1(azimuth);
      }
    };
    ...
    this.setElevation0to1 = function(elevation) {
      if (this._m1obj) {
        this._m1obj.setElevation0to1(elevation);
      }
    };
    ...
    this.setOrbitRotation0to1 = function(orbitRotation) {
      if (this._m1obj) {
        this._m1obj.setOrbitRotation0to1(orbitRotation);
      }
    };
