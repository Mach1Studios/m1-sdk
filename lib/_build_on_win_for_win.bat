...
xcopy _install\vs-15-2017\lib '..\examples\mach1spatial-c\Unreal Engine\Mach1DecodePlugin\Source\Mach1DecodePlugin\ThirdParty\Mach1\bin\Win32' /Y
xcopy _install\vs-15-2017-win64\lib '..\examples\mach1spatial-c\Unreal Engine\Mach1DecodePlugin\Source\Mach1DecodePlugin\ThirdParty\Mach1\bin\Win64' /Y
