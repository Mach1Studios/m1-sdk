...
xcopy _install\vs-15-2017\libUnity ..\examples\mach1spatial-c\Unity\M1DSPGraph\Assets\Mach1\Plugins\Windows\x86 /Y
xcopy _install\vs-15-2017-win64\libUnity ..\examples\mach1spatial-c\Unity\M1DSPGraph\Assets\Mach1\Plugins\Windows\x86_64 /Y

xcopy _install\vs-15-2017\lib "..\examples\mach1spatial-c\Unreal Engine\Mach1DecodePlugin\SourcePlugin\Mach1DecodePlugin\ThirdParty\Mach1\bin\Win32" /Y
...
xcopy _install\vs-15-2017-win64\lib "..\examples\mach1spatial-c\Unreal Engine\Mach1DecodePlugin\SourcePlugin\Mach1DecodePlugin\ThirdParty\Mach1\bin\Win64" /Y
