...
yes | cp -rf "_install/android-ndk-r16b-api-21-armeabi-v7a-neon-clang-libcxx/lib/libMach1DecodeCAPI.a" "../examples/mach1spatial-c/android/mach1-example/app/src/main/jniLibs/armeabi-v7a/libMach1DecodeCAPI.a"
yes | cp -rf "_install/android-ndk-r16b-api-21-armeabi-v7a-neon-clang-libcxx/lib/libMach1EncodeCAPI.a" "../examples/mach1spatial-c/android/mach1-example/app/src/main/jniLibs/armeabi-v7a/libMach1EncodeCAPI.a"
yes | cp -rf "_install/android-ndk-r16b-api-21-armeabi-v7a-neon-clang-libcxx/lib/libMach1DecodePositionalCAPI.a" "../examples/mach1spatial-c/android/mach1-example/app/src/main/jniLibs/armeabi-v7a/libMach1DecodePositionalCAPI.a"
yes | cp -rf "_install/android-ndk-r16b-api-21-arm64-v8a-neon-clang-libcxx/lib/libMach1DecodeCAPI.a" "../examples/mach1spatial-c/android/mach1-example/app/src/main/jniLibs/arm64-v8a/libMach1DecodeCAPI.a"
yes | cp -rf "_install/android-ndk-r16b-api-21-arm64-v8a-neon-clang-libcxx/lib/libMach1EncodeCAPI.a" "../examples/mach1spatial-c/android/mach1-example/app/src/main/jniLibs/arm64-v8a/libMach1EncodeCAPI.a"
yes | cp -rf "_install/android-ndk-r16b-api-21-arm64-v8a-neon-clang-libcxx/lib/libMach1DecodePositionalCAPI.a" "../examples/mach1spatial-c/android/mach1-example/app/src/main/jniLibs/arm64-v8a/libMach1DecodePositionalCAPI.a"
