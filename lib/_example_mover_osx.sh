...
yes | cp -rf "_install/xcode/libBundle/libMach1DecodePositionalCAPI.bundle" "../examples/mach1spatial-c/Unity/cs/Plugins/macOS/libMach1DecodePositionalCAPI.bundle"
