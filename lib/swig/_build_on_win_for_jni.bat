...
mkdir jni\cpp\Mach1
D:\swigwin-4.0.0\swig.exe -c++ -java -outdir jni\java\com\Mach1 -I..\ -o jni\cpp\Mach1\FloatArrayModule_wrap.cxx -package com.Mach1 FloatArrayModule.i 
...
D:\swigwin-4.0.0\swig.exe -c++ -java -outdir jni\java\com\Mach1 -I..\ -o jni\cpp\Mach1\StringModule_wrap.cxx -package com.Mach1 StringModule.i
