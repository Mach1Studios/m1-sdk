...
void M1EncodeCore::processGains(float x, float y, float z, std::vector<float> &result) {
    ...
    static std::vector<Mach1Point3D> m1Spatial_38_Def = {
        // 8ch
            ...
            // 38ch
            {0.0, 0.910592997, 1.473370419},
            {0.618033989, 0.0, 1.618033989},
            {0.0, -0.910592997, 1.473370419},
            {-0.618033989, 0.0, 1.618033989},
            {1.473370419, 0.0, 0.910592997},
            {-1.473370419, 0.0, 0.910592997},
            {0.0, 1.618033989, 0.618033989},
            {0.0, -1.618033989, 0.618033989},
            {0.910592997, 1.473370419, 0.0},
            {1.618033989, 0.618033989, 0.0},
            {1.618033989, -0.618033989, 0.0},
            {0.910592997, -1.473370419, 0.0},
            {-0.910592997, -1.473370419, 0.0},
            {-1.618033989, -0.618033989, 0.0},
