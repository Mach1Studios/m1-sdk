...
public class Mach1DecodeModule {
  ...
  public static void Mach1DecodeCAPI_decodePannedCoeffs(SWIGTYPE_p_void M1obj, SWIGTYPE_p_float result, int bufferSize, int sampleIndex, boolean applyPanLaw) {
    Mach1DecodeModuleJNI.Mach1DecodeCAPI_decodePannedCoeffs(SWIGTYPE_p_void.getCPtr(M1obj), SWIGTYPE_p_float.getCPtr(result), bufferSize, sampleIndex, applyPanLaw);
  }

  public static void Mach1DecodeCAPI_decodeCoeffsUsingTranscodeMatrix(SWIGTYPE_p_void M1obj, SWIGTYPE_p_float matrix, int channels, SWIGTYPE_p_float result, int bufferSize, int sampleIndex) {
    Mach1DecodeModuleJNI.Mach1DecodeCAPI_decodeCoeffsUsingTranscodeMatrix(SWIGTYPE_p_void.getCPtr(M1obj), SWIGTYPE_p_float.getCPtr(matrix), channels, SWIGTYPE_p_float.getCPtr(result), bufferSize, sampleIndex);
  }
