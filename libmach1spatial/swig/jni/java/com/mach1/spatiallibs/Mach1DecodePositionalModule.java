...
public class Mach1DecodePositionalModule {
  ...
  public static Mach1Point3D Mach1DecodePositionalCAPI_getCurrentAngleInternal(SWIGTYPE_p_void M1obj) {
    return new Mach1Point3D(Mach1DecodePositionalModuleJNI.Mach1DecodePositionalCAPI_getCurrentAngleInternal(SWIGTYPE_p_void.getCPtr(M1obj)), true);
  }

  public static Mach1Point3D Mach1DecodePositionalCAPI_getPositionalRotation(SWIGTYPE_p_void M1obj) {
    return new Mach1Point3D(Mach1DecodePositionalModuleJNI.Mach1DecodePositionalCAPI_getPositionalRotation(SWIGTYPE_p_void.getCPtr(M1obj)), true);
  }
  ...
  public static Mach1Point3D Mach1DecodePositionalCAPI_getClosestPointOnPlane(SWIGTYPE_p_void M1obj) {
    return new Mach1Point3D(Mach1DecodePositionalModuleJNI.Mach1DecodePositionalCAPI_getClosestPointOnPlane(SWIGTYPE_p_void.getCPtr(M1obj)), true);
  }
