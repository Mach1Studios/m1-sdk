...
then
	...
	rsync -rc "include/java/jni/" "$(M1SDK_RELEASE_PATH)/mach1spatial-libs/android-ndkr26d-arm64-v8a/include"
	rsync -rc "include/java/jni/" "$(M1SDK_RELEASE_PATH)/mach1spatial-libs/android-ndkr26d-armeabi-v7a/include"
	rsync -rc "include/java/jni/" "$(M1SDK_RELEASE_PATH)/mach1spatial-libs/android-ndkr26d-x86/include"
	rsync -rc "include/java/jni/" "$(M1SDK_RELEASE_PATH)/mach1spatial-libs/android-ndkr26d-x86_64/include"
