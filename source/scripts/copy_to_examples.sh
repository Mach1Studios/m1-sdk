...
then
	...
	# x86
	rsync -c --exclude='*.lib' --include='*.dll' "../mach1spatial-libs/vs-15-2017-x86/lib/Dynamic/Release" "../examples/mach1spatial-c/Unity/Unity-Mach1SpatialAPI/M1UnityDecodeTest/Assets/Mach1/Plugins/Windows/x86"
	rsync -c --exclude='*.lib' --include='*.dll' "../mach1spatial-libs/vs-15-2017-x86/lib/Dynamic/Release" "../examples/mach1spatial-c/Unity/Unity-Mach1SpatialAPI/M1DSPGraph/Assets/Mach1/Plugins/Windows/x86"
	...
	rsync -c --exclude='*.lib' --include='*.dll' "../mach1spatial-libs/vs-15-2017-x86/lib/Dynamic/Release" "../examples/mach1spatial-c/Unreal Engine/UE-Mach1SpatialAPI/Mach1DecodePlugin/SourcePlugin/Mach1DecodePlugin/ThirdParty/Mach1/bin/Win32"
	...
	# x64
	rsync -c --exclude='*.lib' --include='*.dll' "../mach1spatial-libs/vs-15-2017-x86_64/lib/Dynamic/Release" "../examples/mach1spatial-c/Unity/Unity-Mach1SpatialAPI/M1UnityDecodeTest/Assets/Mach1/Plugins/Windows/x86_64"
	rsync -c --exclude='*.lib' --include='*.dll' "../mach1spatial-libs/vs-15-2017-x86_64/lib/Dynamic/Release" "../examples/mach1spatial-c/Unity/Unity-Mach1SpatialAPI/M1DSPGraph/Assets/Mach1/Plugins/Windows/x86_64"
	rsync -c "../mach1spatial-libs/vs-15-2017-x86_64/lib/Static/MD/Release" "../examples/mach1spatial-c/Unreal Engine/UE-Mach1SpatialAPI/Mach1DecodePlugin/SourcePlugin/Mach1DecodePlugin/ThirdParty/Mach1/bin/Win64"
	rsync -c --exclude='*.lib' --include='*.dll' "../mach1spatial-libs/vs-15-2017-x86_64/lib/Dynamic/Release" "../examples/mach1spatial-c/Unreal Engine/UE-Mach1SpatialAPI/Mach1DecodePlugin/SourcePlugin/Mach1DecodePlugin/ThirdParty/Mach1/bin/Win64"
