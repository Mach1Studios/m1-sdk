...
then
	...
	rsync -rc --exclude='*inified*' --exclude='*Encode*' --exclude='*Transcode*' --exclude='*d.*' "../mach1spatial-libs/vs-15-2017-x86/lib/Dynamic/Release/" "../examples/mach1spatial-c/Unreal Engine/UE-Mach1SpatialAPI/Mach1DecodePlugin/SourcePlugin/Mach1DecodePlugin/ThirdParty/Mach1/bin/Win32"
	...
	rsync -rc --exclude='*inified*' --exclude='*Encode*' --exclude='*Transcode*' --exclude='*d.*' "../mach1spatial-libs/vs-15-2017-x86_64/lib/Dynamic/Release/" "../examples/mach1spatial-c/Unreal Engine/UE-Mach1SpatialAPI/Mach1DecodePlugin/SourcePlugin/Mach1DecodePlugin/ThirdParty/Mach1/bin/Win64"
