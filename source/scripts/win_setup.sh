...
if [ ! -z "$TESTPATH" ]; then
    ...
    if [[ "$PWD" == *source ]]
    then
        mkdir -p _install/vs-15-2017/Release/lib-shared
        mkdir -p _install/vs-15-2017/Debug/lib-shared
        mkdir -p _install/vs-15-2017-win64/Release/lib-shared
        mkdir -p _install/vs-15-2017-win64/Debug/lib-shared
        mkdir -p _install/vs-15-2017/Release/lib
        mkdir -p _install/vs-15-2017/Debug/lib
        mkdir -p _install/vs-15-2017-win64/Release/lib
        mkdir -p _install/vs-15-2017-win64/Debug/lib
        mkdir -p _install/vs-15-2017-mt/Release/lib
        mkdir -p _install/vs-15-2017-mt/Debug/lib
        mkdir -p _install/vs-15-2017-win64-mt/Release/lib
        mkdir -p _install/vs-15-2017-win64-mt/Debug/lib
    fi
fi